...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0f1117] text-[#e2e4f0] overflow-hidden">
      {/* header */}
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-[#2a2d45] bg-[#161820] flex-shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded bg-[#5b6af0] flex items-center justify-center">
          ...
          <span className="text-sm font-semibold text-[#e2e4f0]">Gantt Planner</span>
        </div>
        <div className="flex-1" />
        <span className="text-xs text-[#5a6080]">Your workspace link gives full access — keep it private</span>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {currentProjectId ? (
          <div className="flex flex-1 overflow-hidden">
            {/* task tree panel */}
            <div className="flex flex-col border-r border-[#2a2d45]" style={{ width: TREE_WIDTH, flexShrink: 0 }}>
              {/* tree header */}
              <div className="flex items-center px-3 h-[52px] border-b border-[#2a2d45] bg-[#161820] flex-shrink-0">
                <span className="text-xs font-medium text-[#9098c0]">Task / Item</span>
              </div>
              {/* tree body */}
              <div
                ref={treeScrollRef}
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl bg-[#161820] border border-[#2a2d45] flex items-center justify-center mx-auto mb-4">
